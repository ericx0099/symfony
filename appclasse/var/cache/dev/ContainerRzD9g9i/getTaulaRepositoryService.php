 ...
 */
class getTaulaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaulaRepository' shared autowired service.
     *
     * @return \App\Repository\TaulaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaulaRepository.php';

        return $container->privates['App\\Repository\\TaulaRepository'] = new \App\Repository\TaulaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
