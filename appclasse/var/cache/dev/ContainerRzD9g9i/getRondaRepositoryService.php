 ...
 */
class getRondaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RondaRepository' shared autowired service.
     *
     * @return \App\Repository\RondaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RondaRepository.php';

        return $container->privates['App\\Repository\\RondaRepository'] = new \App\Repository\RondaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
