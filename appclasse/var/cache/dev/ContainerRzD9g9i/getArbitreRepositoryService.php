 ...
 */
class getArbitreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArbitreRepository' shared autowired service.
     *
     * @return \App\Repository\ArbitreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArbitreRepository.php';

        return $container->privates['App\\Repository\\ArbitreRepository'] = new \App\Repository\ArbitreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
