...
class __TwigTemplate_0cf07e3516cd54ca492cd0d2130c4b697141443b4406a17b2bbb73542d55aebd extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "<h1>";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["ronda"]) || array_key_exists("ronda", $context) ? $context["ronda"] : (function () { throw new RuntimeError('Variable "ronda" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1), "html", null, true);
        echo "</h1>";
    ...
    {
        return new Source("<h1>{{ ronda.id }}</h1>", "ronda/profile.html.twig", "/app/appclasse/templates/ronda/profile.html.twig");
    }
}
