...
class __TwigTemplate_5cc87dcfd23c0539d1cdffacea17bbf8e41545b2357e6730e0d6be1a2b49e628 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 7
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["post_form"]) || array_key_exists("post_form", $context) ? $context["post_form"] : (function () { throw new RuntimeError('Variable "post_form" does not exist.', 7, $this->source); })()), 'form_start', ["attr" => ["class" => "box"]]);
        echo "
                        ";
        // line 8
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["post_form"]) || array_key_exists("post_form", $context) ? $context["post_form"] : (function () { throw new RuntimeError('Variable "post_form" does not exist.', 8, $this->source); })()), 'form');
        echo "
                        ";
        // line 9
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["post_form"]) || array_key_exists("post_form", $context) ? $context["post_form"] : (function () { throw new RuntimeError('Variable "post_form" does not exist.', 9, $this->source); })()), 'form_end');
        echo "
                        ";
        // line 10
    ...
    {
        return array (  129 => 19,  125 => 17,  120 => 16,  111 => 13,  107 => 11,  103 => 10,  99 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{{ form_start(post_form,{'attr':{'class':'box'}}) }}
                        ...
                        {% endfor %}
{% endblock %}", "user/register.html.twig", "/app/appclasse/templates/user/register.html.twig");
    }
}
